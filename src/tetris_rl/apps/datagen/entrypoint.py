# src/tetris_rl/apps/datagen/entrypoint.py
...
from tetris_rl.core.config.root import DataGenConfig
from tetris_rl.core.datagen.pipeline.plan import DataGenPlan
from tetris_rl.core.datagen.pipeline.runner import run_datagen
...
def run_datagen_job(args: argparse.Namespace) -> int:
...
__all__ = ["parse_args", "run_datagen_job"]
