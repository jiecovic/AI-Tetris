# src/tetris_rl/core/datagen/pipeline/runner.py
...
from tetris_rl.core.datagen.pipeline.progress import MultiWorkerProgress
from tetris_rl.core.utils.file_io import write_json
...
def _init_worker_progress_queue(q: Any) -> None:
    ...
    from tetris_rl.core.datagen.workers.worker import _set_worker_progress_queue
