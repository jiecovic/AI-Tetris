# src/tetris_rl/core/policies/sb3/spatial/stems/conv3x3_32_32_64_row1_col3_128.py
"""
Preset CNN stem for 20x10-ish boards (Tetris), slightly more vertical mixing:
...
class Conv3x3_32_32_64Row1Col3_128Stem(nn.Module):
    ...
    def __init__(self, *, in_channels: int, dropout: float = 0.0) -> None:
        ...
        layers: list[nn.Module] = [
            ...
            nn.ReLU(),
            _drop(),
            nn.Conv2d(32, 32, kernel_size=(3, 3), stride=1, padding=(1, 1), bias=True),
            nn.ReLU(),
            _drop(),
...
__all__ = ["Conv3x3_32_32_64Row1Col3_128Stem"]
