# src/tetris_rl/training/runners/experiment.py
from __future__ import annotations

from omegaconf import DictConfig

from tetris_rl.training.runners.ga import run_ga_experiment
from tetris_rl.training.runners.rl import run_rl_experiment
