# src/tetris_rl/game/rendering/pygame/hud_panel.py
...
from tetris_rl.game.rendering.pygame.palette import Palette
from tetris_rl.game.rendering.pygame.surf import blit_text
